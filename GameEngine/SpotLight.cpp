...
SpotLight::SpotLight(GLfloat shadowWidth, GLfloat shadowHeight,
	...
	GLfloat con, GLfloat lin, GLfloat exp, GLfloat edg) : PointLight (shadowWidth, shadowHeight, near, far, red, green, blue , aIntensity, dIntensity, xPos, yPos, zPos, con, lin, exp)
{
